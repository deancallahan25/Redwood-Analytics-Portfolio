...
for i in range(len(df_filtered["COMMON_NAME"].value_counts())):
  ...
  #put in new dataframes
  train = feature_train.loc[feature_train['COMMON_NAME'] == tree_name]
  test = feature_test.loc[feature_test['COMMON_NAME'] == tree_name]
...
print(f"Height squared:\nAverage RMSLE for k = 3- {avg_rmsle}") 
...
avg_rmsle = sum(rmsle)/len(rmsle) 
print(f"Height and diameter interaction:\nAverage RMSLE for k = 3- {avg_rmsle}") 
...
avg_rmsle = sum(rmsle)/len(rmsle) 
print(f"Volume of cylinder feature:\nAverage RMSLE for k = 3- {avg_rmsle}") 
```

<<<<<<< HEAD

=======
>>>>>>> 91177b9a96467b13cef66fb2c71a5dea96f6b2d7
# Quality Assurance
