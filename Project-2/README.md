...
- simulated_commuter_survey_5yrs_messy.csv: a simulated data set which contains sample messy survey results describing transportation information from students, staff, and faculty. It was cleaned and used in the app as the file "lon_lat_final_data.csv".
...
- jack-pass-bus-stops.csv: A dataset created by our Domain Expert which describes bus stops locations which students can use for free with their Jack Pass. 
